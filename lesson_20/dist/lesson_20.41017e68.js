...
// Создать класс  Human, который в качестве аргумента принимает объект с ключами name(содержит ваше имя строкой), age(содержит ваш возраст числом). 
...
// У класса AlevelStudent должен быть метод averageMark, который выводит в консоль среднее значение из вашего массива оценок
...
//# sourceMappingURL=/lesson_20.41017e68.map