...
var Dom = function () {
    ...
    _createClass(Dom, [{
        ...
        key: "setCoordinates",
        value: function setCoordinates(key) {
...
var LocationApi = function () {
    ...
    _createClass(LocationApi, [{
        ...
        value: function getMyLocation(ip) {
            return fetch("https://freegeoip.net/json/" + ip).then(function (res) {
                if (res.status === 200) {
                    return res.json();
                } else {
                    throw new Error(res.status);
...
var Weather = function () {
    ...
    _createClass(Weather, [{
        ...
        value: function getWeather(city) {
            return fetch("https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=" + this.key).then(function (res) {
                if (res.status === 200) {
                    return res.json();
                } else {
                    throw new Error(res.status);
...
var _location_ip = require("./location_ip.js");

var _location_ip2 = _interopRequireDefault(_location_ip);
...
var location = new _location_ip2.default();
...
btn.addEventListener("click", function () {
  dom.showPreloader();
  location.getMyIp().then(function (res) {
    return location.getMyLocation(res.ip);
  }).then(function (res) {
...
//  weather.getWeather()
},{"./dom.js":17,"./location_ip.js":18,"./weather.js":19}],26:[function(require,module,exports) {
...
//# sourceMappingURL=/weather_api.6611a605.map