...
},{"./emptyFunction":18}],24:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./lib/ReactPropTypesSecret":24}],10:[function(require,module,exports) {
...
},{"object-assign":16,"fbjs/lib/invariant":14,"fbjs/lib/emptyObject":15,"fbjs/lib/warning":17,"fbjs/lib/emptyFunction":18,"prop-types/checkPropTypes":13}],9:[function(require,module,exports) {
'use strict';
...
},{"object-assign":16,"./lib/ReactPropTypesSecret":24,"./checkPropTypes":13}],8:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./factoryWithTypeCheckers":12}],19:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./isTextNode":28}],26:[function(require,module,exports) {
'use strict';
...
},{"./camelize":27}],11:[function(require,module,exports) {
/** @license React v16.4.1
...
},{"fbjs/lib/invariant":14,"react":9,"fbjs/lib/warning":17,"fbjs/lib/ExecutionEnvironment":19,"object-assign":16,"fbjs/lib/emptyFunction":18,"prop-types/checkPropTypes":13,"fbjs/lib/getActiveElement":25,"fbjs/lib/shallowEqual":20,"fbjs/lib/containsNode":21,"fbjs/lib/emptyObject":15,"fbjs/lib/hyphenateStyleName":22,"fbjs/lib/camelizeStyleName":23}],7:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.development.js":11}],2:[function(require,module,exports) {
'use strict';
  ...
  _createClass(TodoItem, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        this.props.value,
        _react2.default.createElement('div', { className: 'markText', onClick: this.props.onToggle }),
        _react2.default.createElement(
          'button',
          { className: 'delItem', onClick: this.props.deleteItem },
          'X'
        )
      );
    }
...
var TodoApp = function (_React$Component2) {
  ...
  _createClass(TodoApp, [{
    ...
    value: function onCompletedToggle(id) {
      var result = this.state.list.filter(function (item) {
        return item.id === id;
      })[0];
    ...
    key: 'onItemDelete',
    value: function onItemDelete(id) {
    ...
    key: 'onItemAllChecked',
    value: function onItemAllChecked(e) {
      var stateList = this.state.list;
      stateList.forEach(function (key) {
    ...
    key: 'onItemRemoveChecked',
    value: function onItemRemoveChecked() {
      this.setState({
        list: this.state.list.filter(function (item) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { className: 'main_input', type: 'text', placeholder: 'What need to be done', onKeyDown: this.onItemAdd.bind(this) }),
        this.state.list.map(function (item) {
          return _react2.default.createElement(TodoItem, {
            id: item.id,
            value: item.value,
            completed: item.completed,
            onToggle: _this3.onCompletedToggle.bind(_this3, item.id),
            key: item.id,
            deleteItem: _this3.onItemDelete.bind(_this3, item.id)
        ...
        _react2.default.createElement('input', { className: 'checkAllitem', type: 'checkbox', onClick: this.onItemAllChecked.bind(this) }),
        this.state.list.filter(function (elem) {
          return elem.completed;
        }).length ? _react2.default.createElement(
          'div',
          { className: 'delAll', onClick: this.onItemRemoveChecked.bind(this) },
          'Clear completed'
        ) : null
      );
    }
...
},{"react":9,"prop-types":8,"react-dom":7}],39:[function(require,module,exports) {
...
//# sourceMappingURL=/lesson_28.88b9e58a.map